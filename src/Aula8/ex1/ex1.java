...
public class ex1 {
    ...
    public static void main(String[] args) {
        ...
        AutomovelLigeiro automovelLigeiro1 = new AutomovelLigeiro("12348", "Fiat", "Palio", 150, 12345, 5);
        automovelLigeiro1.trajeto(20);
        AutomovelLigeiro automovelLigeiro2 = new AutomovelLigeiro("12349", "Fiat", "Palio", 130, 12345, 5);
