...
public class AutomovelLigeiroEletrico extends AutomovelLigeiro implements VeiculoEletrico {
    ...
    public String toString() {
        return "AutomovelLigeiroEletrico{" + "matricula=" + getMatricula() + ", marca=" + getMarca() + ", modelo=" + getModelo() + ", potenciaCv=" + getPotenciaCv() + ", numeroDoQuadro=" + getNumeroDoQuadro() + ", capacidadeDaBagageira=" + getbagageira() + ", autonomia_maxima=" + autonomia_maxima + ", carga=" + carga + '}';
    }
